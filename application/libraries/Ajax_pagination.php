...
class Ajax_pagination{
    ...
    function create_links(){
        ...
        switch($this->per_page)
        {
         ...
         $outOf = round($this->total_rows / $this->per_page); 
        ...
        $info = "<td colspan='".$this->colspan."'><table border='0' width='100%' style='font-size:12px;'><tr><td align='left' width='200' class='page_info'><select style='padding:4px; border:1px solid #ddd;' name='limit' id='".$this->limit."' onchange='".$this->link_func."();' class='span4'>
                ...
                <option value='100' $sel5 >100</option>              
                  </select> Records Per Page</td><td width='200' align='center' class='page_info'>Page <input type='text' style='padding:4px; border:1px solid #ddd;' name='gotopage' value='".$this->cur_page."' size='1' class='span2' onUnfocus onkeyup=\"if(!isNum(this.value)) this.value='1'; \"> of ".$outOf. " Pages</td><td class='page_info'>Total ".$this->total_rows." records found</td>";
