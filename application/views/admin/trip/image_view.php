   ...
   <div class="container-fluid">
      ...
      <div class="span12">
        <!-- BEGIN EXAMPLE TABLE widget-->
         ...
         <div class="row"> 
        <div class="col-md-3"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i> TRIP IMAGE (<?php echo $project_name;?>)</span><img src="<?=base_url('assets/breadcornor.png')?>" style="top: -2px;position:relative;" /></h4></div>
        <!--
        <div class="col-md-6">
	...
	-->	
			<div class="col-md-2">
			 <div style="text-align: right;"> <a href="<?php echo base_url('admin/trip')?>" class="btn btn-default"><i class="icon-angle-left"></i> Back </a></div>
		</div>
        ...
        <div class="widget-body">
                ...
                <table class="table table-striped table-bordered" >
                            ...
                            <tbody id="postList">                        
                             ...
                             <?php $this->load->view('admin/trip/image_in'); ?>
                            </tbody>
                          </table>                      
