   ...
   <div class="container-fluid">
      ...
      <div class="span12">
        <!-- BEGIN EXAMPLE TABLE widget-->
         ...
         <div class="row"> 
        <div class="col-md-3"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i>  MANAGE PACKAGE </span><img src="<?=base_url('assets/breadcornor.png')?>" style="top: -2px;position:relative;" /></h4></div>
        <div class="col-md-6">
			...
			<div class="col-md-4">
			  <button id="btnSearch"  class="btn btn search" onclick="searchFilter()"><i class="icon-search"></i> Search</button><a href="<?php echo base_url('admin/project');?>" class="btn "><i class="fa fa-refresh" aria-hidden="true"></i></a>
			</div>
		</div>
     <div class="col-md-2">
      
    
      <div style="text-align: right;"><a href="<?= base_url('admin/project/add')?>" class="btn bg-maroon btn-flat margin"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;ADD PACKAGE</a></div>
        ...
        <div class="widget-body">
                ...
                <table class="table table-striped table-bordered" >
                            ...
                            <tbody id="postList">                        
                             ...
                             <?php $this->load->view('admin/project/project_in'); ?>
                            </tbody>
                          </table>                      
...
<script>
	function searchFilter(page_num,cur_page) {
	  ...
	  $.ajax({
		type: 'GET',
		url: '<?=base_url('admin/project/ajaxPaginationData')?>/'+page_num,
		...
		success: function (html) {
		  $('#postList').html(html);
			window.history.pushState("object or string", "Title", "<?=base_url('admin/project?')?>"+dataVar);
