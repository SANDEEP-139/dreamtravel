<?php
 //print_r($user);
    ...
    <tr id="<?=$values->id?>">
	<td><?=$n?></td>
	<td><?php echo ucwords($values->first_name." ".$values->last_name)?></a></td>
    <td><?= $values->email ?></td>  

    <td><?= $values->phone ?></td> 
    <td><?= $values->enquiry_type ?></td> 
    ...
    <td style="text-align:center;">
		<div class="btn-group">
			...
			<ul class="dropdown-menu" role="menu">
				<li>
					<a href="javascript:void(null);" onclick="return deleterow('<?=strrev(ENQUIRY)?>','id','<?=$values->id?>');"><i class="fa fa-trash" aria-hidden="true" class="btn"></i>Delete </a>
				</li>
