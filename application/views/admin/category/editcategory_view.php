...
<div class="row">
  <br>
        <div class="col-md-6"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i>  <?php //echo $title?> Edit Trip Category </span><img src="<?php echo  base_url();?>assets/breadcornor.png" style="top: -2px;position:relative;" /></h4></div>
    ...
    <div class="row-fluid box" style="padding:10px;">
      ...
      <div class="widget" id="form_wizard_1">
        ...
        echo form_open('admin/category/editcategory',$attributes); 
        ?>
          ...
          <div class="tab-pane active" id="tab1">
              ...
              <div class="row">
            <div class="col-md-3">
              <label class="control-label">Category Title<font color="#FF0000">*</font> :</label>
              </div>
              <div class="col-md-9">
                <div class="controls">
                 <input type="hidden" name="cat_id" value="<?= $category[0]->id?>">
                <input type="text" class="form-control" name="name" placeholder="Category Title" value="<?php echo $category[0]->category_title; ?>" data-validation="required" >
                  <br />
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                <textarea name="description" id="description"  class="form-control ckeditor" data-validation="required" placeholder="description"><?= $category[0]->category_desc?></textarea>
                  <br />
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                 <input type="hidden" name="img" value="<?= $category[0]->image ?>" />
        ...
        <!--     <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                  <a href="<?= base_url('admin/category')?>" class="btn btn-default"><i class="icon-angle-left"></i> Back </a>
