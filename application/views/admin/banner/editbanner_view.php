...
<div class="row">
  <br>
        <div class="col-md-6"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i>  <?php //echo $title?> Edit Banner </span><img src="<?php echo  base_url();?>assets/breadcornor.png" style="top: -2px;position:relative;" /></h4></div>
    ...
    <div class="row-fluid box" style="padding:10px;">
      ...
      <div class="widget" id="form_wizard_1">
        ...
        echo form_open('admin/banner/editbanner',$attributes); 
        ?>
          ...
          <div class="tab-pane active" id="tab1">
              ...
              <div class="row">
            <div class="col-md-3">
              <label class="control-label">Banner Title<font color="#FF0000">*</font> :</label>
              </div>
              <div class="col-md-9">
                <div class="controls">
                 <input type="hidden" name="cat_id" value="<?= $banner[0]->id?>">
                <input type="text" class="form-control" name="name" placeholder="Banner Title" value="<?php echo $banner[0]->banner_title; ?>" data-validation="required" >
                  <br />
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                <textarea name="description" id="description"  class="form-control ckeditor" data-validation="required" placeholder="description"><?= $banner[0]->banner_desc?></textarea>
                  <br />
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                 <input type="hidden" name="img" value="<?= $banner[0]->image ?>" />
                <input type="file" class="form-control" name="imgname"  placeholder="Name">
                  <br />
                
                <a href="<?= base_url($banner[0]->image) ?>" target="_blank"><img src="<?= base_url($banner[0]->image) ?> " height="50" width="50"></a>
                  <p id="res"></p>
        ...
        <!--     <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                  <a href="<?= base_url('admin/banner')?>" class="btn btn-default"><i class="icon-angle-left"></i> Back </a>
