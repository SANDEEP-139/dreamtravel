...
<div class="row">
  <br>
        <div class="col-md-6"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i>  <?php //echo $title?> Edit Product </span><img src="<?php echo  base_url();?>assets/breadcornor.png" style="top: -2px;position:relative;" /></h4></div>
    ...
    <div class="row-fluid box" style="padding:10px;">
      ...
      <div class="widget" id="form_wizard_1">
        ...
        echo form_open('admin/product/editproduct',$attributes); 
        ?>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                 <input type="hidden" name="cat_id" value="<?= $product[0]->id?>">
                <input type="text" class="form-control" name="name" placeholder="Product Title" value="<?php echo $product[0]->title; ?>" data-validation="required" >
                  <br />
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                <textarea name="description" id="description"  class="form-control ckeditor" data-validation="required" placeholder="description"><?= $product[0]->description?></textarea>
                  <br />
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                ...
                <a href="<?= base_url($product[0]->image) ?>" target="_blank"><img src="<?= base_url($product[0]->image) ?> " height="50" width="50"></a>
                  <p id="res"></p>
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
                <div class="controls">
                  <a href="<?= base_url('admin/product')?>" class="btn btn-default"><i class="icon-angle-left"></i> Back </a>
