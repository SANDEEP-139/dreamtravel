...
<div class="row">
  <br>
        <div class="col-md-6"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i>  <?php //echo $tit?> Add Video </span><img src="<?php echo  base_url();?>assets/breadcornor.png" style="top: -2px;position:relative;" /></h4></div>
    ...
    <div class="row-fluid box" style="padding:10px;">
      ...
      <div class="widget" id="form_wizard_1">
        ...
        echo form_open('admin/video/addVideo',$attributes); 
        ?>
          ...
          <div class="tab-pane active" id="tab1">
            ...
            <div class="col-md-3">
              ...
              <div class="col-md-9">
               ...
               <input type="text" class="form-control" name="videourl" placeholder="Video Url" value="<?php echo set_value('videourl'); ?>" data-validation="required">
                  <br />
                  <p id="res"></p>
           ...
           -->
            <div class="control-group">
              <label class="control-label">&nbsp;</label>
                <div class="controls">
                  <a href="<?php echo base_url('admin/video')?>" class="btn btn-default"><i class="icon-angle-left"></i> Back </a>
