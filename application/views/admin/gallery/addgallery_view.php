...
<div class="row">
  <br>
        <div class="col-md-6"><h4><span class="breadcornor"><i class="fa fa-users" aria-hidden="true"></i>  <?php //echo $tit?> Add Gallery </span><img src="<?php echo  base_url();?>assets/breadcornor.png" style="top: -2px;position:relative;" /></h4></div>
    ...
    <div class="row-fluid box" style="padding:10px;">
      ...
      <div class="widget" id="form_wizard_1">
        ...
        echo form_open('admin/gallery/addGallery',$attributes); 
        ?>
           ...
           -->
            <div class="control-group">
              <label class="control-label">&nbsp;</label>
                <div class="controls">
                  <a href="<?php echo base_url('admin/gallery')?>" class="btn btn-default"><i class="icon-angle-left"></i> Back </a>
