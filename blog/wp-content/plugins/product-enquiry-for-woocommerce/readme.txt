...
= Can I modify the Inquiry Form to fit my needs? =
No. You have to use the default inquiry form. Having said that, the Pro version comes with an in-built custom form builder that allows you to add custom fields in the Inquiry form as per your needs.
